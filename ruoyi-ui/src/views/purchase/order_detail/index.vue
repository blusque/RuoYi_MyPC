  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="订单编号" prop="number">
        <el-input v-model="queryParams.number" placeholder="请输入订单编号" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item label="物料编号" prop="number">
        <el-input v-model="queryParams.number" placeholder="请输入物料编号" clearable @keyup.enter.native="handleQuery" />
      </el-form-item>
      <el-form-item>
    ...
    <el-table v-loading="loading" :data="detailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="总额" align="center" prop="number" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="总额" prop="number">
          <el-input v-model="form.number" placeholder="请输入订单总额" />
        </el-form-item>
      </el-form>
...
<script>
import { listDetail, getDetail, delDetail, addDetail, updateDetail } from "@/api/purchase/order_detail";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        materialId: [
          { required: true, message: "materialId不能为空", trigger: "blur" }
        ],
        number: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除采购订单明细编号为"' + orderIds + '"的数据项？').then(function () {
