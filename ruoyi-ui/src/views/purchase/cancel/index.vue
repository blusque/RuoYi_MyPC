<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="退换物料数量" prop="number">
        <el-input
          v-model="queryParams.number"
          placeholder="请输入退换物料数量"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="detailList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="退换物料数量" align="center" prop="number" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="退换物料数量" prop="number">
          <el-input v-model="form.number" placeholder="请输入物料数量" />
        </el-form-item>
      </el-form>
...
<script>
import { listDetail, getDetail, delDetail, addDetail, updateDetail } from "@/api/purchase/cancel";
