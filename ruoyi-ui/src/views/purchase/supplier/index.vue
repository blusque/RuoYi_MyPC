<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="主供应货物" prop="email">
        <el-input
          v-model="queryParams.email"
          placeholder="请输入主供应货物"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="供应商评级" prop="level">
        <el-input
          ...
          placeholder="请输入供应商评级"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="供应商折扣" prop="discount">
        <el-input
          v-model="queryParams.discount"
          placeholder="请输入供应商折扣"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
    ...
    <el-table v-loading="loading" :data="supplierList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="主供应货物" align="center" prop="email" />
      <el-table-column label="供应商评级" align="center" prop="level" />
      <el-table-column label="供应商折扣" align="center" prop="discount" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="主供货物" prop="email">
          <el-input v-model="form.email" placeholder="请输入主供货物" />
        </el-form-item>
        <el-form-item label="供应商评级" prop="level">
          <el-input v-model="form.level" placeholder="请输入供应商评级" />
        </el-form-item>
        <el-form-item label="供应商折扣" prop="discount">
          <el-input v-model="form.discount" placeholder="请输入供应商折扣" />
        </el-form-item>
        <el-form-item label="供应商地址" prop="address">
...
<script>
import { listSupplier, getSupplier, delSupplier, addSupplier, updateSupplier } from "@/api/purchase/supplier";
  ...
  data() {
    return {
      ...
      rules: {
        ...
        level: [
          { required: true, message: "供应商评级不能为空", trigger: "blur" }
        ],
        address: [
